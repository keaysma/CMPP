...
class Sidebar extends Component {
  ...
  updatePixels(){
    if(cam){
	  ...
	  this.mod.freq(10*((firstSlider.value()+secondSlider.value()+thirdSlider.value())/(3*800)));
...
export function sketch (p) {
  ...
  firstSlider = p.createSlider(-12000, -6000, -9000);
  firstSlider.position(30,50);
	firstSlider.size(250);
  secondSlider = p.createSlider(-4000, 6000, 1000);
  secondSlider.position(30,150);
  secondSlider.size(250);
  thirdSlider = p.createSlider(4000, 16000, 10000);
  thirdSlider.position(30,250);
  thirdSlider.size(250);
  fourthSlider = p.createSlider(-1000, 1000, 0);
